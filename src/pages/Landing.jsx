  ...
  return (
    <>
      ...
      <div className='flex flex-col justify-center  '>
        ...
        <div className="mt-5">
           <Link to={'/home'}> <button className='bg-[#a7e1f9] hover:bg-[#1c6bb0] hover:text-[#a7e1f9] p-2  px-4 text-[#1c6bb0] font-semibold rounded-sm'>Get Started <FontAwesomeIcon className='ms-1' icon={faArrowRight} /> </button></Link>
